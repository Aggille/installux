object frmRelRecibosVcto: TfrmRelRecibosVcto
  Left = 345
  Top = 143
  BorderStyle = bsToolWindow
  Caption = 'Recibos por vencimento'
  ClientHeight = 100
  ClientWidth = 277
  Color = clMoneyGreen
  ...
  object qryRecibos: TIBQuery
    ...
    SQL.Strings = (
      'SELECT'
        ...
        'r.id,  r.saldo  as saldo , r.valor, r.servicos_cobrado, r.materi' +
        'ais_cobrado, r.cliente, r.servicos, r.materiais, r.data, r.venci' +
      ...
      'r.vencimento between :vencimentoinicial and :vencimentofinal and'
        ...
        '( ( r.saldo - r.desconto ) > 0 or ( r.saldo > 0 and r.desconto i' +
        's null ) ) '
      ''
      ''
      'order by '
  ...
  object rvRecibosPorVcto: TRvDataSetConnection
